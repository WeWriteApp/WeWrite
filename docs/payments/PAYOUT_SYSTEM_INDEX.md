...
- Payouts transfer **from Storage Balance** to connected accounts; the **payout fee (10%)** is retained in **Payments Balance**.
...
**WeWrite Allocation Fee**: 7% of each allocation (deducted when supporters allocate to creators)
**WeWrite Payout Fee**: 10% of payout amount (deducted when creators cash out earnings)
**Stripe Payout Fees**:
