...
WeWrite uses a header system to provide consistent navigation and user experience across the application, with different headers for different page types.
...
### 1. FinancialHeader - Navigation Pages Only
**Purpose**: Sticky financial header for logged-in users on navigation pages
**File**: `app/components/layout/FinancialHeader.tsx`
...
- **Financial header**: FinancialHeader is automatically hidden on these pages
...
### When FinancialHeader Shows (NavPages)
- ✅ Home page (`/`)
...
### When FinancialHeader is Hidden
