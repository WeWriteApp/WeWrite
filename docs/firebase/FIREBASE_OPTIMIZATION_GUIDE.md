...
- [FIREBASE_REST_API_ARCHITECTURE.md](./FIREBASE_REST_API_ARCHITECTURE.md) - API architecture
- [PERFORMANCE_OPTIMIZATION_GUIDE.md](../performance/PERFORMANCE_OPTIMIZATION_GUIDE.md) - General performance
