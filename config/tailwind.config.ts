    ...
    extend: {
      colors: {
        ...
        neutral: {
          ...
          1: "oklch(var(--neutral-base) / 0.01)",
          5: "oklch(var(--neutral-base) / 0.05)",
          10: "oklch(var(--neutral-base) / 0.10)",
          15: "oklch(var(--neutral-base) / 0.15)",
          20: "oklch(var(--neutral-base) / 0.20)",
          25: "oklch(var(--neutral-base) / 0.25)",
          30: "oklch(var(--neutral-base) / 0.30)",
          40: "oklch(var(--neutral-base) / 0.40)",
          50: "oklch(var(--neutral-base) / 0.50)",
          60: "oklch(var(--neutral-base) / 0.60)",
          70: "oklch(var(--neutral-base) / 0.70)",
          80: "oklch(var(--neutral-base) / 0.80)",
          90: "oklch(var(--neutral-base) / 0.90)",
          100: "oklch(var(--neutral-base))",
        },
        // Semantic Colors with Opacity Variations
        error: {
          DEFAULT: "oklch(var(--error))",
          foreground: "oklch(var(--error-foreground))",
          1: "oklch(var(--error) / 0.01)",
          5: "oklch(var(--error) / 0.05)",
          10: "oklch(var(--error) / 0.10)",
          15: "oklch(var(--error) / 0.15)",
          20: "oklch(var(--error) / 0.20)",
          25: "oklch(var(--error) / 0.25)",
        ...
        success: {
          ...
          1: "oklch(var(--success) / 0.01)",
          5: "oklch(var(--success) / 0.05)",
          10: "oklch(var(--success) / 0.10)",
          15: "oklch(var(--success) / 0.15)",
          ...
          100: "oklch(var(--success))",
        },
        warning: {
          DEFAULT: "oklch(var(--warning))",
          foreground: "oklch(var(--warning-foreground))",
          1: "oklch(var(--warning) / 0.01)",
          5: "oklch(var(--warning) / 0.05)",
          10: "oklch(var(--warning) / 0.10)",
          15: "oklch(var(--warning) / 0.15)",
          20: "oklch(var(--warning) / 0.20)",
          25: "oklch(var(--warning) / 0.25)",
