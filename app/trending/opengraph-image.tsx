...
export const alt = 'Trending on WeWrite';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Discover what's popular on WeWrite
          </div>
          <div
            style={{
              fontSize: '24px',
          ...
          >
            See the most-read pages, rising creators, and the topics everyone's talking about.
          </div>
        </div>

        {/* Right side - Trending Preview */}
        <div
          style={{
            display: 'flex',
            flexDirection: 'column',
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
              ...
              <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.5)' }}>
                by @productivity_pro • 2.4k views
              </div>
            </div>
            <div
              style={{
