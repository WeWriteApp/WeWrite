...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen justify-center items-center bg-gray-50 text-center px-6">
      <div className="max-w-4xl">
        ...
        >
          <a 
            href="/get-started" 
            className="bg-black hover:bg-blue-700 text-white text-lg font-semibold py-3 px-6 rounded-md transition duration-300 shadow-lg"
          >
            Get Started
          </a>
        </motion.div>
