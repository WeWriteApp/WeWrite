...
// Interactive Pie Chart Demo Component
function PieChartShowcase() {
  const [segment1Value, setSegment1Value] = React.useState(60);
  const [segment2Value, setSegment2Value] = React.useState(25);
  const [segment3Value, setSegment3Value] = React.useState(15);
  ...
  return (
    <div className="wewrite-card space-y-4">
      <div className="border-b border-border pb-4">
        ...
        <p className="text-sm text-muted-foreground">app/components/ui/pie-chart.tsx</p>
        <p className="text-sm text-muted-foreground mt-1">
