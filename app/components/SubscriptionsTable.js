...
const SubscriptionsTable = () => {
  ...
  return (
    <div className="subscriptions-table mt-6">
      <h2 className="text-xl text-white font-bold">Subscriptions</h2>
      {/* Budget Metrics */}
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          className={`text-white px-4 py-2 rounded ${
            showAll ? "bg-blue-500" : "bg-gray-700"
          }`}
...
const BudgetMetrics = ({ totalBudget, usedBudget }) => {
  ...
  return (
    <div className="budget-metrics mb-4 bg-gray-800 p-4 rounded-lg flex justify-between items-center text-white">
      <div>
