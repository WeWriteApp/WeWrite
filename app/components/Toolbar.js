...
import { Menu, Plus, Bell, User, Shuffle } from "lucide-react";
...
export default function Toolbar() {
  ...
  const { setIsOpen: setDrawerOpen } = useContext(DrawerContext) || { setIsOpen: () => console.log("DrawerContext not available") };
  ...
  return (
    <div
      id="toolbar"
      className={`fixed bottom-0 left-0 right-0 h-16 ${isLightMode ? 'bg-white text-black' : 'bg-primary text-white'} flex items-center justify-between px-4 z-[2147483647] shadow-lg`}
    >
