...
export function SubscriptionInfoModal({ children, trigger, currentTier = null, currentStatus = null, userId = null, username = null }: TierModalProps) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md max-h-[80vh] overflow-y-auto rounded-lg border border-border dark:border-neutral-700 bg-white dark:bg-neutral-900 animate-in fade-in-0 zoom-in-95 duration-300 mx-4 my-8 w-[calc(100%-2rem)] px-6 py-6">
        <DialogClose asChild>
