// @ts-nocheck
import React, { useState, useContext, useRef, forwardRef, useImperativeHandle, useEffect, Dispatch, SetStateAction } from "react";
import {
  createEditor,
  Transforms,
  Editor,
...
// Define prop types for SlateEditor
...
const SlateEditor = forwardRef<any, SlateEditorProps>(({
  initialEditorState = [],
  setEditorState,
  initialContent,
