...
export default function ContentCarousel({
  ...
  const containerClasses = fullWidth
    ? "relative overflow-hidden py-4 w-screen -ml-[calc(50vw-50%)]"
  ...
  return (
    ...
    >
      <div
        ref={carouselRef}
        className="flex gap-1 overflow-x-auto pb-2 hide-scrollbar w-full h-full"
        style={{
          scrollbarWidth: 'none',
          msOverflowStyle: 'none',
          WebkitOverflowScrolling: 'touch',
          paddingLeft: fullWidth ? '16px' : 'max(16px, calc((100vw - 1440px) / 2))',
          paddingRight: fullWidth ? '16px' : 'max(16px, calc((100vw - 1440px) / 2))',
          cursor: 'grab',
