...
interface TextViewErrorBoundaryProps {
  children: ReactNode;
  fallbackContent?: ReactNode;
}

interface TextViewErrorBoundaryState {
  hasError: boolean;
  error: Error | null;
 ...
 */
class TextViewErrorBoundary extends Component<TextViewErrorBoundaryProps, TextViewErrorBoundaryState> {
  constructor(props: TextViewErrorBoundaryProps) {
    super(props);
    this.state = {
      hasError: false,
      error: null,
  ...
  static getDerivedStateFromError(error: Error): Partial<TextViewErrorBoundaryState> {
