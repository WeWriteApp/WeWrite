 ...
 */
export function SEOAnalytics({ showDebugInfo = false, enableRealTimeTracking = true }: SEOAnalyticsProps) {
 ...
 */
export function SEOScoreBadge({ score, size = 'medium' }: SEOScoreBadgeProps) {
...
interface SEOQuickActionsProps {
  onOptimize?: () => void;
  onValidate?: () => void;
  onExport?: () => void;
}
 ...
 */
export function SEOQuickActions({ onOptimize, onValidate, onExport }: SEOQuickActionsProps) {
  return (
    <div style={{
      display: 'flex',
      gap: '10px',
