...
export const alt = 'Sign in to WeWrite';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Sign in to continue writing, earning, and connecting with your audience.
          </div>
          <div
            style={{
              display: 'flex',
        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.4)' }}>or</div>
              <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255, 255, 255, 0.1)' }} />
            </div>
