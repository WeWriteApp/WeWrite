...
export const alt = 'Create your WeWrite account';
export const size = {
  width: 1200,
  height: 630,
};
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Blurred gradient blobs - blue tones, bigger and brighter */}
        <div
          style={{
            position: 'absolute',
            top: '-300px',
        ...
        >
          ...
          >
            Start writing & earning on WeWrite
          </div>
          <div
            style={{
              fontSize: '26px',
          ...
          >
            Create your free account to publish pages, build your audience, and earn from your writing.
          </div>
          <div
            style={{
              display: 'flex',
        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '13px', color: 'rgba(255, 255, 255, 0.4)' }}>or</div>
              <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255, 255, 255, 0.1)' }} />
            </div>
