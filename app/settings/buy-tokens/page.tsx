...
export default function BuyTokensPage() {
  console.log('🚀 BuyTokensPage component mounting...');
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      const checkoutUrl = new URL('/settings/buy-tokens/checkout', window.location.origin);
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-red-600">
                ...
                Token Purchase Data Error
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <p className="text-muted-foreground">
                  There was an issue loading your token purchase data: {subscriptionError}
                </p>
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-32 md:pb-8">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <TokenPurchaseHistory className="mt-6" />
        </div>
