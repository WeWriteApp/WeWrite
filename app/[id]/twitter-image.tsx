/**
 * Twitter Image Generator for Dynamic Pages
 *
 * X/Twitter has specific requirements for card images:
 * - Recommended size: 1200x628 (slightly different from OG's 1200x630)
 * - Must have twitter:card meta tag set to "summary_large_image"
...
export const size = {
  width: 1200,
  height: 628, // Twitter prefers 628 over 630
};
    ...
    (
      <div
        style={{
          backgroundColor: '#000',
          width: '1200px',
          height: '628px', // Twitter-specific height
          display: 'flex',
          flexDirection: 'column',
      ...
      >
        ...
        <div style={{
          position: 'absolute',
          bottom: '118px', // Adjusted for 628 height
          left: '0px',
          right: '0px',
          height: '120px',
        ...
        <div style={{
          ...
          left: '0px',
          right: '0px',
          height: '118px', // Adjusted for 628 height
          backgroundColor: '#000',
          display: 'flex',
          alignItems: 'center',
          paddingLeft: '60px',
          ...
          <div style={{
            ...
            <svg width="68" height="68" viewBox="0 0 1024 1024" fill="none">
